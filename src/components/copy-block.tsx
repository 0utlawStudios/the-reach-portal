...
export function CopyBlock({ text, label, className = "", mono = false }: CopyBlockProps) {
  ...
  return (
    <div className={`group relative ${className}`}>
      ...
      <div
        onClick={handleCopy}
        className={`relative bg-gray-50 dark:bg-white/[0.03] border border-gray-200/80 dark:border-white/[0.06] rounded-xl px-4 py-3 pr-12 cursor-pointer hover:border-orange-300 dark:hover:border-orange-500/30 hover:bg-orange-50/30 dark:hover:bg-orange-500/[0.03] transition-all duration-200 ${mono ? "font-mono" : ""}`}
      >
