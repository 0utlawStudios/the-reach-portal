      ...
      <div className="card-premium relative bg-white dark:bg-[#131316] rounded-2xl border border-gray-100/80 dark:border-white/[0.06] p-4 sm:p-5 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_6px_24px_rgba(0,0,0,0.03)] dark:shadow-[0_1px_3px_rgba(0,0,0,0.2),0_6px_24px_rgba(0,0,0,0.15)] overflow-hidden" style={{ '--card-gradient': darkCardGradients[6] } as React.CSSProperties}>
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-[22px] font-extrabold tracking-[-0.03em] bg-gradient-to-r from-gray-900 via-gray-800 to-gray-600 dark:from-white dark:via-gray-200 dark:to-gray-400 bg-clip-text text-transparent">
          ...
          <div className="space-y-4 flex-1 flex flex-col justify-center">
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[24px] font-black text-gray-900 dark:text-white tabular-nums font-mono tracking-tighter">
    ...
    <Card idx={4} onClick={() => navigate("calendar")} className="lg:col-span-3 flex flex-col group">
      ...
      <div className="grid grid-cols-7 gap-0.5">
        {calendarDays.map((day, i) => {
          ...
          return (
            <div key={day} className={`aspect-square rounded-lg flex flex-col items-center justify-center relative transition-all duration-200 ${
      ...
      <div className="flex items-center justify-center gap-3 mt-3 pt-3 border-t border-gray-100/60 dark:border-white/[0.04]">
      ...
      <p className="text-[9px] text-gray-300 dark:text-gray-600 text-center mt-auto pt-2 group-hover:text-blue-400 transition-colors duration-300">Click to open full calendar →</p>
    </Card>
  );
}
