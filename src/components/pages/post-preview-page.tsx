...
function InstagramPreview({ card }: { card: ContentCard }) {
  return (
    <div className="w-[340px] bg-white rounded-xl overflow-hidden border border-gray-200 shadow-lg">
      ...
      <div className="aspect-square w-full bg-gray-100"><img src={card.thumbnailUrl} alt="" className="w-full h-full object-cover" /></div>
...
function FacebookPreview({ card }: { card: ContentCard }) {
  return (
    <div className="w-[400px] bg-white rounded-xl overflow-hidden border border-gray-200 shadow-lg">
      ...
      <div className="aspect-video w-full bg-gray-100"><img src={card.thumbnailUrl} alt="" className="w-full h-full object-cover" /></div>
...
function YouTubePreview({ card }: { card: ContentCard }) {
  return (
    <div className="w-[420px] bg-white rounded-xl overflow-hidden border border-gray-200 shadow-lg">
      <div className="aspect-video w-full bg-black relative"><img src={card.thumbnailUrl} alt="" className="w-full h-full object-cover" />
          ...
          {previewableCards.map((card) => {
            ...
            return (
              <button key={card.id} onClick={() => { setSelectedId(card.id); setActiveTab(card.platforms[0]); }}
                ...
                <img src={card.thumbnailUrl} alt="" className="w-12 h-12 rounded-xl object-cover shrink-0 shadow-sm" />
                <div className="flex-1 min-w-0">
