...
const FIELD_GUIDANCE: Record<string, string> = {
  ...
  "date": "Pick the scheduled publish date from the calendar input.",
  "time": "Set the exact publish time in the field next to the date.",
  "scheduled date": "Click the schedule area and pick a publish date.",
  "scheduled time": "Set the exact post time next to the date picker.",
  "hook": "Write a hook that grabs attention in the first 3 seconds.",
  "caption": "Write the caption text that goes with your post.",
