...
// on every authenticated page; clicking it opens a Messenger-style panel with
// two tabs: Submit a ticket and Chat. Shown to end users only — the superadmin
// answers from Settings → Support Inbox, so the widget is hidden for that role.
...
export function SupportWidget() {
  ...
  const { openThread, markRead, closeThread, sendMessage, createTicket, loadChat, sendChatMessage } =
    support;
