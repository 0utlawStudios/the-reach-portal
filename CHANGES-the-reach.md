...
- Dashboard fit/density: removed the shared forced-height card wrapper, stopped the summary row from consuming viewport flex height, and distributed existing dashboard card content across tall viewports.
