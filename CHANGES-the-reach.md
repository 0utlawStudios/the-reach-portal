...
- Dashboard fit/density: removed the shared forced-height card wrapper, stopped the summary row from consuming viewport flex height, distributed existing dashboard card content across tall viewports, and made short desktop viewports scroll instead of clipping behind the footer.
